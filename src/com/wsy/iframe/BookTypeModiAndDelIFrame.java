...
public class BookTypeModiAndDelIFrame extends JInternalFrame {
	...
	class ButtonAddListener implements ActionListener {
		public void actionPerformed(ActionEvent e) {
			...
			int i = Dao.UpdatebookType(BookTypeId.getText().trim(), selectedItem.toString(), days.getText().trim(),
					fk.getText().trim());
	...
	/*
	 * class ButtonDelListener implements ActionListener{ public void
	 * actionPerformed(ActionEvent e){ int
	 * i=Dao.DelbookType(BookTypeId.getText().trim()); if(i==1){
	 * JOptionPane.showMessageDialog(null, "删除成功"); Object[][]
