...
public class BookBackIFrame extends JInternalFrame {
	...
	class TableListener extends MouseAdapter {
		public void mouseClicked(final MouseEvent e) {
			...
			int days2, days3;
			// days1=java.sql.Timestamp.valueOf(table.getValueAt(selRow,
			// 6).toString().trim()).getDate()-java.sql.Timestamp.valueOf(table.getValueAt(selRow,
			// 5).toString().trim()).getDate();
